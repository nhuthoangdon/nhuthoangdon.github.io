$(document).ready(function() {
  ...
  var cvTL = new TimelineMax({paused: true});
      cvTL.to(".story", 1.8, {text:{value:"I <b>graduated</b> in <b>2014</b> with a Bachelor Degree in <b>Multimedia Design</b>"}}, 'label-start')
          ...
          .set('.title', {text: 'Versions for A/B testing'})
          ...
          .to('.story', 1, {text:{value: "As for the <b>tools</b>"}, delay: 1.2})
          .to(".story", .2, {text:{value:""}, delay: 1})
          ...
          .set('.story', {letterSpacing: ".05rem", display: 'block', autoAlpha: 1})
          .to(".story", 1, {text:{value:"and have a <b>good understanding</b> of"}, delay: .5})
          ...
          .to('.story', 1.8, {text:{value: "that not only satisfy user needs"}})
          .to(".story", .2, {text:{value:""}, delay: 1.6})
          .to('.story', 2, {text:{value: "but more importantly"}})
          .to(".story", .2, {text:{value:""}, delay: 1.6})
          .to('.story', 3, {text:{value: "also serve a good purpose to the world."}})
